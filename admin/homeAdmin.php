        ...
        <div class="relative flex justify-between h-16">
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div id="navbar-menu" class="hidden sm:ml-6 sm:flex sm:space-x-8">
                    <a href="homeAdmin.php" class=" text-gray-900 inline-flex items-center px-1 pt-1 text-3xl font-serif hover:border-red-500 hover:shadow-md border-b-2 border-transparent">Titan Fit</a>
                ...
                <a href="../client/perfilClient.php" class=" text-gray-900 inline-flex items-center px-1 pt-1 text-sm font-serif hover:border-red-500 hover:shadow-md border-b-2 border-transparent">Meu Perfil</a>
